...
contract yWrappedVault is ERC20, ERC20Detailed {
    ...
    address public constant vault = 0x29E240CFD7946BA20895a7a02eDb25C210f9f324;
    ...
    function balanceUnderlying() public view returns (uint) {
        return IERC20(vault).balanceOf(address(this)).mul(yVault(vault).getPricePerFullShare()).div(1e18);
    }
