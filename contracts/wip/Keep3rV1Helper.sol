...
contract Keep3rV1Helper {
    ...
    IUniswapV2SlidingOracle public constant UV2SO = IUniswapV2SlidingOracle(0xCA2E2df6A7a7Cf5bd19D112E8568910a6C2D3885);
    ...
    function getQuoteLimitFor(address origin, uint gasUsed) public view returns (uint) {
        uint _min = quote(gasUsed.mul(uint(FASTGAS.latestAnswer())));
        uint _boost = _min.mul(BOOST).div(BASE);
