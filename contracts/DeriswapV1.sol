...
contract DeriswapV1Pair is DeriswapV1ERC20 {
    ...
    function createOption(address token, uint amount, uint st, uint t, uint optionType, uint maxFee) public {
        ...
        require(_fee > 0 && _fee <= maxFee, "maxFee");
    ...
    function excerciseOption(uint id) external {
        ...
        address _t0 = TOKEN0;
        if (_o.optionType == 0) {
            IERC20(_t0 == _o.asset ? TOKEN1 : _t0).safeTransferFrom(msg.sender, address(this), _o.strike.mul(_o.amount).div(IERC20(_o.asset).decimals()));
            ...
            IERC20(_t0 == _o.asset ? TOKEN1 : _t0).safeTransfer(msg.sender, _o.strike.mul(_o.amount).div(IERC20(_o.asset).decimals()));
        }
